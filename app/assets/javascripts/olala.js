...
Aloha.settings = {
  plugins: {
    load: "common/ui, common/format, common/undo, common/paste", //"common/format, common/table, common/list, common/link, common/block, , common/commands, common/abbr, extra/browser, extra/linkbrowser",
    format:{
      config: ['b', 'i', 'removeFormat']
    }
  }
};
